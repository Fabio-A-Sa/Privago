...
\acmConference[G53]{PRI}{November-12, 2023}{Porto, Portugal}
%
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q1-p-r-curve-simple.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q1-p-r-curve-boosted.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q2-p-r-curve-simple.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q2-p-r-curve-boosted.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q3-p-r-curve-simple.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q3-p-r-curve-boosted.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q4-p-r-curve-simple.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{imgs/q4-p-r-curve-boosted.png}
